...
![3.1-1](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/3.1-1.PNG)

然后一直选择下一步，直到“选择服务器角色”；如图选择“web服务器(IIS)”

![3.1-2](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/3.1-2.PNG)

在“角色服务”中选择“WebSocket协议”**（这一步很重要，选漏了 IIS 将无法代理 WebSocket ，无法正常使用）**，其他功能不是必须，可以按需选择。

![3.1-3](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/3.1-3.PNG)
...
![4-1](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/4-1.PNG)

然后在右边选择“Server Proxy Settings...”

![4-2](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/4-2.PNG)

接下来把“Enable Proxy”打上勾，然后在右边选择应用

![4-3](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/4-3.PNG)

在右侧导航栏选择你的站点，然后双击进入“URL重写”（我这里用 IIS 默认创建的站点做演示）

![4-4](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/4-4.PNG)

点击“添加规则”$\to$选择“反向代理”$\to$“确定”

![4-5](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/4-5.PNG)
...
![4-6](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/4-6.PNG)

如果你在 Jupyter 上配置了 SSL 则还有下面两步：

1. 双击打开你刚刚创建的规则

![4-7](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/4-7.PNG)
...
![4-9](https://dlysy.github.io/PictureBads/DLYSYBlog/tech/IIS反向代理JupyterLab/4-9.PNG)
